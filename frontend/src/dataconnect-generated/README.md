...
```typescript
listPublicMovieLists(options?: ExecuteQueryOptions): QueryPromise<ListPublicMovieListsData, undefined>;
...
```typescript
listPublicMovieLists(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<ListPublicMovieListsData, undefined>;
